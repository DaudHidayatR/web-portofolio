---
title: About Me
photo: '@assets/about/daud-hidayat-ramadhan-scaled.webp'
link: https://www.linkedin.com/in/daud-hidayat-ramadhan
---
...
My core stack includes **Go**, **PHP**, **Laravel**, **REST APIs**, **Docker**, **Kubernetes**, **Ansible**, **OpenBao**, and CI/CD security tooling such as SAST, dependency scanning, container scanning, and secret scanning. Cloud and infrastructure tools such as Linux, Nginx, GCP, and Cloudflare support the work, but the primary focus of this site is DevSecOps and Backend engineering.
